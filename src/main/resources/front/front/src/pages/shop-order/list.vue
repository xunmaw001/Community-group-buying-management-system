    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          ...
          <el-button v-show="activeName == '拼团中'" type="danger" :style='{"margin":"2px auto",}' size="mini" @click="cancelGroup(scope.row)">取消拼团</el-button>
      ...
      cancelGroup(item) {
            this.$confirm(`是否取消拼团？`, "提示", {
              ...
              this.$http.get(item.tablename+'/info/'+item.goodid, {}).then(res => {
                  ...
                  let good = res.data.data;
                  // 减少拼团人数
                  good.curpeople = good.curpeople - 1;
