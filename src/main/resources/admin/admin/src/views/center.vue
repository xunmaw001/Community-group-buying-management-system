  ...
  <div :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="商铺编号" prop="shangpubianhao">
          <el-input v-model="ruleForm.shangpubianhao" readonly              placeholder="商铺编号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="商铺名称" prop="shangpumingcheng">
          <el-input v-model="ruleForm.shangpumingcheng"               placeholder="商铺名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="商铺地址" prop="shangpudizhi">
          <el-input v-model="ruleForm.shangpudizhi"               placeholder="商铺地址" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='shangjia'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='shangjia'" label="商铺图片" prop="shangputupian">
          <file-upload
          tip="点击上传商铺图片"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.shangpubianhao)&& 'shangjia'==this.flag){
      ...
      if((!this.ruleForm.shangpumingcheng)&& 'shangjia'==this.flag){
