	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商铺地址" prop="shangpudizhi">
					<el-input v-model="ruleForm.shangpudizhi" placeholder="商铺地址" clearable  :readonly="ro.shangpudizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商铺地址" prop="shangpudizhi">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.shangputupian" label="商铺图片" prop="shangputupian">
					<file-upload
						tip="点击上传商铺图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.shangputupian" label="商铺图片" prop="shangputupian">
					<img v-if="ruleForm.shangputupian.substring(0,4)=='http'" class="upload-img" style="margin-right:20px;" v-bind:key="index" :src="ruleForm.shangputupian.split(',')[0]" width="100" height="100">
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangputupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
			</template>
