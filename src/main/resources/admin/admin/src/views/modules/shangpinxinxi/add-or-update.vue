	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商铺编号" prop="shangpubianhao">
					<el-input v-model="ruleForm.shangpubianhao" placeholder="商铺编号" clearable  :readonly="ro.shangpubianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商铺编号" prop="shangpubianhao">
					<el-input v-model="ruleForm.shangpubianhao" placeholder="商铺编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商铺名称" prop="shangpumingcheng">
					<el-input v-model="ruleForm.shangpumingcheng" placeholder="商铺名称" clearable  :readonly="ro.shangpumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商铺名称" prop="shangpumingcheng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="团购价" prop="groupprice">
					<el-input v-model="ruleForm.groupprice" placeholder="团购价" clearable  :readonly="ro.groupprice"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="团购价" prop="groupprice">
					<el-input v-model="ruleForm.groupprice" placeholder="团购价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="拼团人数" prop="grouppeople">
					<el-input v-model="ruleForm.grouppeople" placeholder="拼团人数" clearable  :readonly="ro.grouppeople"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="拼团人数" prop="grouppeople">
					<el-input v-model="ruleForm.grouppeople" placeholder="拼团人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="当前人数" prop="curpeople">
					<el-input v-model="ruleForm.curpeople" placeholder="当前人数" clearable  :readonly="ro.curpeople"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="当前人数" prop="curpeople">
...
export default {
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.shangpubianhao!=''&&json.shangpubianhao) || json.shangpubianhao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.shangpubianhao = json.shangpubianhao
						this.ro.shangpubianhao = true;
					}
					if(((json.shangpumingcheng!=''&&json.shangpumingcheng) || json.shangpumingcheng==0) && this.$storage.get("role")!="管理员"){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../springboot975sz/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
