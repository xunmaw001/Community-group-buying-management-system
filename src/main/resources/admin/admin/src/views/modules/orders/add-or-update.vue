	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商户名称" prop="shangpubianhao">
					<el-input v-model="ruleForm.shangpubianhao" placeholder="商户名称" clearable  :readonly="ro.shangpubianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="商户名称" prop="shangpubianhao">
					<el-input v-model="ruleForm.shangpubianhao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="团购编号" prop="groupno">
					<el-input v-model="ruleForm.groupno" placeholder="团购编号" clearable  :readonly="ro.groupno"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="团购编号" prop="groupno">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springboot975sz/upload');
        } else {
